...
function register_message_listeners() {
    ...
    appu_menu_panel.port.on("open-report", function() {
	    appu_menu_panel.hide();
	    tabs.open({
    ...
    appu_menu_panel.port.on("open-myfootprint", function() {
	    appu_menu_panel.hide();
	    tabs.open({
    ...
    appu_menu_panel.port.on("open-options", function() {
	    appu_menu_panel.hide();
	    tabs.open({
    ...
    appu_menu_panel.port.on("open-about", function() {
	    appu_menu_panel.hide();
	    tabs.open({
    ...
    appu_menu_panel.port.on("open-feedback", function() {
	    appu_menu_panel.hide();
	    tabs.open({
    ...
    appu_menu_panel.port.on("status_change", function() {
	    appu_menu_panel.hide();
	});
}
...
function register_worker_message_listeners(worker) {
    ...
    worker.port.on("query_status", function(message) {
		...
		if (template_processing_tabs[sender.tab.id] != "") {
		    ...
		    this.port.emit("query_status_response", r);
