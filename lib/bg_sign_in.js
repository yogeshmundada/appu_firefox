...
var this_mod = (function (
		    ...
		    function testing_msg_sending(my_worker) {
			timers.setTimeout(function() {
				my_worker.port.emit("this-is-my-test-message");
			    },
			    2000);
		    ...
		    mod_vars.testing_msg_sending = testing_msg_sending;
		    mod_vars.sign_out = sign_out;
		    mod_vars.sign_in = sign_in;
		    mod_vars.create_account = create_account;
		    return mod_vars;
		} (
		  globals.pii_vault,
...
exports.testing_msg_sending       = this_mod.testing_msg_sending;
exports.sign_out       = this_mod.sign_out;
exports.sign_in        = this_mod.sign_in;
exports.create_account = this_mod.create_account;
