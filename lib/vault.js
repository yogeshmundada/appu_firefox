...
//console.log("Here here: In vault, UTIL is:" + JSON.stringify(update_stats));
...
var this_mod = (function (
		...
		function vault_init() {
			...
			this.vault_write("guid", pii_vault.guid);
			...
			console.log("Here here: Flushing pii_vault:current_report: " + 
				    JSON.stringify(pii_vault.config.reportid));

			flush_current_report();
			console.log("Here here: AFTER Flushing pii_vault ");
		    }
		...
		function vault_read() {
		    try {
			//console.log("Here here: EEEEEEEEEEE localstorage.guid: " + localStorage.guid);
...
// 			}
		...
		function vault_write(key, value) {
			...
			console.log("Appu Error: vault_write(), Value is empty for key: " + key);
		...
		function my_set_current_report() {
		    console.log("Here here: In vault:my_set_current_report()");
		    pii_vault.current_report = {
			"init" : true,
		    }
		}

		mod_vars.my_set_current_report = my_set_current_report;
		mod_vars.vault_init = vault_init;
		mod_vars.vault_read = vault_read;
		mod_vars.flush_current_report = flush_current_report;
		mod_vars.flush_aggregate_data = flush_aggregate_data;
		mod_vars.vault_write = vault_write;
		mod_vars.flush_selective_entries = flush_selective_entries;
		return mod_vars;
	    }(
	      globals.pii_vault,
	      ...
	      util.read_file,
	      update_stats.initialize_report,
	      update_stats.initialize_aggregate_data,
	      util.print_appu_error
	      ));

// var my_mod = (function(my_test_value) {
// 	var mod = {};
// 	mod.my_test_func = function() {
// 	    console.log("Here here: In my_test_func(), value: " + my_test_value);
// 	};
// 	return mod;
// }(main.my_test_value));

//exports.my_test_func = my_mod.my_test_func;
exports.my_set_current_report	= this_mod.my_set_current_report;
exports.vault_init	        = this_mod.vault_init;
exports.vault_read	        = this_mod.vault_read;
exports.vault_write	        = this_mod.vault_write;
exports.flush_current_report    = this_mod.flush_current_report;
exports.flush_aggregate_data    = this_mod.flush_aggregate_data;
exports.flush_selective_entries = this_mod.flush_selective_entries;